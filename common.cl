...
struct MaterialData {
  float4 color;      // it either is a static color or gets calculated with the
                     // location and normal
  float specularity; // 1.0 = 100% reflective
  float transparent; // 1 if not transparent at all, 0 if completely
                     // transparent, this has to do with beers law
