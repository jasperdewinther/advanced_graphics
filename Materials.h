...
struct MaterialData
{
	...
	float transparent; // 0 if not transparent, 1 if completely transparent, this has to do with beers law
...
const MaterialData materials[9] = {
	...
	MaterialData(float3(1.f,1.f,1.f), 1.0f, 0.0001f, 1.52f),
	MaterialData(float3(0.878f,0.066f,0.373f), 1.0f, 0.1f, 1.77f), //ruby
};