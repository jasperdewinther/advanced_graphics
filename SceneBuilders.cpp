...
Scene SceneBuilders::glass_dragon()
{
	...
	s.triangles.push_back(get_mesh_from_file("./assets/buddha.obj", 3.f, Material::yellow));
	//s.triangles.push_back(get_mesh_from_file("./assets/isHibiscus.obj", 0.01f, Material::cyan));
	s.triangles.push_back(get_mesh_from_file("./assets/bunny.obj", 1.f, Material::white_light));
